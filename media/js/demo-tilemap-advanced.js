...
Game = (function(){
    var Game = {
        ...
        draw: function() {
            ...
            small.draw('Bound b1 of map', ballon1.position.x - 40, ballon1.position.y + 20)
            small.draw('Bound b2 of map', ballon2.position.x - 40, ballon2.position.y + 20)
            small.draw('Bound b3 of map', ballon3.position.x - 40, ballon3.position.y + 20)
            small.draw('Bound b4 of map', ballon4.position.x - 40, ballon4.position.y + 20)
