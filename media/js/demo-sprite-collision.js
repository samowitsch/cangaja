...
Game = (function () {
    var Game = {
        ...
        draw:function () {
            ...
            small.draw('This sprite example shows the collision function.', xpos, ypos + 56 + small.getLineHeight())
            small.draw(spritecollisiontext, xpos, ypos + 56 + (small.getLineHeight() * 2))
